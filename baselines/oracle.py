...
def run_oracle(task_id: str, seed: int = 7) -> dict:
    ...
    for case_id in list(env._state.queue_order):
        ...
        if case.case_type.value == "refund":
            if case.workflow_data.get("dispute_should_accept") and case.amount <= 75:
                env.step(AcceptDisputeAction(case_id=case_id))
            elif case.true_fraud_risk > 0.7:
            ...
            if case.true_is_duplicate:
                ...
                if case.pending_info_fields:
                    ...
                    env.step(AdvanceClockAction(minutes=case.hidden_response_latency_minutes or 30))
                ...
                if case.workflow_data.get("secondary_approval_required"):
                ...
                if env._state.cases[case_id].workflow_data.get("payment_hold"):
            ...
            if not case.true_doc_valid:
                ...
                if not case.kyc_complete:
                    ...
                    env.step(AdvanceClockAction(minutes=case.hidden_response_latency_minutes or 45))
