...
emit tool calls.  Then GRPO fine-tunes the actual policy decisions.
...
Usage:
    ...
    # Step 3: GRPO from the warm-started adapter
    python scripts/train_refund_grpo.py \
        --model artifacts/sft-warmstart-adapter \
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", default="artifacts/sft-warmstart-adapter")
    ...
    print(f"[sft_warmstart] Saved adapter to {args.output_dir}")
